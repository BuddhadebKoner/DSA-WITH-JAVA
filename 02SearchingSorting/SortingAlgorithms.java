...
public class SortingAlgorithms {
   ...
   public static void insertion(int[] arr, boolean verbose) {
      if (!isSortable(arr)) {
         return;
      }
   ...
   public static void selection(int[] arr, boolean verbose) {
      if (!isSortable(arr)) {
         return;
      }
   ...
   public static void bubble(int[] arr, boolean verbose) {
      if (!isSortable(arr)) {
         return;
      }
